...
<div>
	{#if !profiles.github}
		<a class="p-button--base has-icon" href="/github/login?redirect_uri=/ui/" rel="external">
			<GitHubIcon />
	...
	{#if !profiles.launchpad}
		<a class="p-button--base has-icon" href="/launchpad/login?redirect_uri=/ui/" rel="external">
			<LaunchpadIcon />
